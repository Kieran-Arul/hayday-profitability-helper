...
public class Item {
    ...
    private int xp;
    private Integer productionTimeInMinutes;
    private int level;
    ...
    public Item(String name, int maxPrice, int xp, Integer productionTimeInMinutes, int level, ItemSource source) {
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        return maxPrice == item.maxPrice
                && xp == item.xp
                && Objects.equals(productionTimeInMinutes, item.productionTimeInMinutes)
                && level == item.level
